...
5. Follow the [core principle](CONTRIBUTING.md#核心原则): contributors who cannot explain their changes and their interaction with the rest of the system will have their PRs closed. Run coding agents from the LearnMate root directory and follow this file's rules. This review policy does not authorize agents to close PRs automatically.
