...
| [PRD.md](reference/PRD.md) | `docs/PRD.md` | Product goals, scenarios, requirements, design constraints, acceptance checks, and open questions. |
...
5. Keep official requirements in the competition document and reference them from the PRD instead of maintaining duplicates. Maintain product requirements in the PRD and record implementation choices and discussions in the relevant issue or PR. Do not create ADRs or standalone long-term memory documents. Use English filenames and harness instructions; product document content follows the user's requested language.
